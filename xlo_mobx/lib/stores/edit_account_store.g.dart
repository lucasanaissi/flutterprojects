...
mixin _$EditAccountStore on _EditAccountStore, Store {
  ...
  bool get isFormValid =>
      (_$isFormValidComputed ??= Computed<bool>(() => super.isFormValid,
          ...
          .value;
  Computed<dynamic>? _$saveFormPressedComputed;

  @override
  dynamic get saveFormPressed => (_$saveFormPressedComputed ??=
          Computed<dynamic>(() => super.saveFormPressed,
              name: '_EditAccountStore.saveFormPressed'))
      .value;
  ...
  final _$_saveFormAsyncAction = AsyncAction('_EditAccountStore._saveForm');

  @override
  Future<void> _saveForm() {
    return _$_saveFormAsyncAction.run(() => super._saveForm());
  }

  final _$_changePassAsyncAction = AsyncAction('_EditAccountStore._changePass');

  @override
  Future<void> _changePass() {
    return _$_changePassAsyncAction.run(() => super._changePass());
  }
...
saveFormPressed: ${saveFormPressed}
    ''';
  }
}
